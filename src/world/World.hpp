...
//  void updateChunkUpdateList();
  ...
  static void addRelatedChunks(const glm::ivec3 &blockPosInChunk, const glm::ivec3 &chunkPos, std::unordered_set<glm::ivec3> &chunkSet, bool addAll = false);
  void addRelatedChunksToChunk();
