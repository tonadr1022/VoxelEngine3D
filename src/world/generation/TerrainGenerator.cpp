...
for (int x = 0; x < CHUNK_SIZE; x++) {
  for (int y = 0; y < CHUNK_SIZE-1; y++) {
    for (int z = 0; z < WORLD_HEIGHT_BLOCKS; z += CHUNK_SIZE) {
//      blocks[WORLD_HEIGHT_XYZ(0,0, z)] = Block::STONE;
//      blocks[WORLD_HEIGHT_XYZ(0,1, z)] = Block::STONE;
//      blocks[WORLD_HEIGHT_XYZ(1,0, z)] = Block::STONE;
  blocks[WORLD_HEIGHT_XYZ(x,y, z)] = Block::STONE;
